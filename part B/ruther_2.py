...
q1 = constants.e * 79  # Large nucleus charge (Gold)
q2 = constants.e * 2   # Small nuclear charge (Alpha particle)
...
print(f"Interaction radius: {r_int}")
...
def collide(b):
    rvals = []                  # Record the trajectory of the particle for plotting
...
ax.plot([0.0], [0.0], 'ro', label="Gold Nucleus") # Target at origin
ax.set_aspect(aspect=1.0)

# Simulate and plot multiple impact parameters
...
plt.show()  # Required to display the plot in standard Python environments
